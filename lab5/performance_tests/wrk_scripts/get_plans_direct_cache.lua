-- Lua скрипт для wrk для тестирования GET /plans endpoint напрямую с Planning Service (WITH CACHE)
...
function init(args)
    print("Starting performance test for GET /plans (WITH CACHE)")
...
function done(summary, latency, requests)
    io.write("-------- Summary (WITH CACHE DIRECT) --------\n")
    ...
    io.write("-------- Latency (WITH CACHE DIRECT) --------\n")
